                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 space-x-1'>
                    ...
                    <div className='col-span-6 flex flex-col justify-center'>
                        <Fade direction={'up'} delay={400} cascade damping={1e-1} triggerOnce={true}>
                            <h1 className="text-xl lg:text-3xl font-semibold mb-5 text-lightgrey md:4px lg:text-start text-center">
                                Find the Perfect Rental Car for <br />  Your Next Adventure 
                            </h1>
                        </Fade>
                    ...
                    <div className='col-span-6 flex justify-center relative'>
                        <div className='flex bg-white p-2 gap-5 items-center bottom-10 left-10 rounded-xl absolute'>
                            <Image src={'/images/Banner/moreCars.jpg'} alt="pizza-image" width={68} height={68} />
                            <p className='text-lg font-normal'>More than 500+ <br /> cars.</p>
                        </div> 
                        <Image src="/images/Banner/carBanner.jpg" alt="nothing" className='ImagBannerCar' width={1000} height={405} />
                    </div>
                </div>
            </div>
        </div>
